...
namespace QuanLyDiem.Areas.HSClient.Controllers
{
    public class QLGiaoViensClientController : Controller
    {
        ...
        // GET: HSClient/QLGiaoViensClient/Edit/5
        ...
        // POST: HSClient/QLGiaoViensClient/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: HSClient/QLGiaoViensClient/Delete/5
        ...
        // POST: HSClient/QLGiaoViensClient/Delete/5
